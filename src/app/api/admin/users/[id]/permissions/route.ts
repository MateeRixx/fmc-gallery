/**
 * API Route: PATCH /api/admin/users/[id]/permissions
 *
 ...
 * - Old Co-Head becomes new Head: PATCH /api/admin/users/oldCoHeadId/permissions { newRole: "head" }
 * - Old Executive becomes new Co-Head: PATCH /api/admin/users/executiveId/permissions { newRole: "co_head" }
