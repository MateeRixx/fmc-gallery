    ...
    <Link href={`/events/${event.slug}`} className="group block">
      ...
      >
        <div className="relative aspect-4/5">
          <Image src="https://images.unsplash.com/photo-1726200290596-7e4fc55bb77d?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHxfA%3D%3D" alt={event.title} fill className="object-cover" />
        </div>
